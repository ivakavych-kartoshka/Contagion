...
\begin{frame}{Tóm tắt trong một phút}
  \begin{itemize}
    ...
    \item \textbf{Cách làm:} khung đo với \textbf{hai protocol độc lập}, 5 model / 5 nhà phát triển
          model, 3 topology.
...
\begin{frame}{Phương pháp (2): cấu hình}
  \begin{itemize}
    ...
    \item \textbf{5 model / 5 nhà phát triển độc lập:} Llama 3.3 70B (Meta) · DeepSeek
          V3.2 (DeepSeek) · Claude Sonnet 4.5 (Anthropic) · Nova Pro (Amazon) ·
...
\begin{frame}{Sản phẩm hiện có}
  \begin{itemize}
    ...
    \item Quy mô: 5 model / 5 nhà phát triển, $\sim$45 thư mục kết quả, hàng chục nghìn lượt gọi model.
  \end{itemize}
\end{frame}
